...
async function fillThatBitchUp(ns, target, worker) {
	...
	//Weaken if over secThreshold as not to make the grow take forever
	if ((ns.getServerSecurityLevel - ns.getServerMinSecurityLevel(target)) > secThresh) {
